...
<head>
    ...
    <script src="js/faculties_modal.js" defer></script>
    <script src="/frontend/Admin/js/filter.js" defer></script>
    <script src="js/faculties.js" defer></script>
...
<body>
<div class="wrapper">
    <?php include "include/faculties_sidebar.php";?>
    <div class="main-content">
        <div class="header-bar">
            <button id="addNewFacultyBtn"><i class="fas fa-plus"></i> New Faculty</button>
        ...
        <div class="profile-container">
            ...
            <main class="profile-content">
                <h2><?php echo count($faculties);?> faculties found</h2>
                <table id="class-table" class="teachers-table">
                    ...
                    foreach ($faculties as $faculty){
                        $fID = $faculty[0];
                        $programmes = totalProgrammesOf($fID);
                        ?>
                        <tr>
                            <td><a href="faculty/profile.php?id=<?php echo $fID;?>"><?php echo $faculty[1];?></a></td>
                            <td><?php echo $programmes;?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                </table>
...
<?php include "include/faculties_modal.php"; ?>
