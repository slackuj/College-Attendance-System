...
<div id="export-faculties" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <span class="close-button">&times;</span>
            <h1>Download Faculties</h1>
        </div>
        ...
        <div class="modal-body">
            ...
            <input id="fileName" value="<?php echo 'Faculties' . '_' . date('Y-m-d')?>">
...
<div id="create-faculty" class="modal">
    <div class="modal-content">
        <div class="modal-header">
        ...
        <div class="modal-body">
            <form action="" method="post">
                ...
                <input id="fname" type="text" placeholder="Faculty Name">
            </form>
      <div class="buttons">
          <div class="modal-footer">
...
<div id="bulk-faculties" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <span class="close-button3">&times;</span>
            <h1>Bulk Create Faculties</h1>
        </div>
