<?php
    ...
    ?>
<div id="edit-subject" class="modal">
...
<form action="" method="post">
        ...
        <input type="text" id="sname" class="editSubject" value="<?php echo $sname; ?>"/>
        <label for="ccode">Course Code</label>
        <input type="text" id="ccode" class="editSubject" value="<?php echo $course_code; ?>"/>
        <label for="ccredit">Course Credit</label>
        <input type="text" id="ccredit" class="editSubject" value="<?php echo $course_credit;?>"/>
</form>
      <div class="buttons">
