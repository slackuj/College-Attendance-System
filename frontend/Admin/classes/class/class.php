...
if (isset($_GET['id'])){
    ...
    if ($row[4] == 0){
        ...
        $assignBtn = "Reassign Class";
    }
    else if ($row[4] == -1){
        $tname = "not assigned";
        $dateHeader = "Unassigned Date";
        $assignBtn = "Assign Class";
    }
    $cdate = $row[3];
...
<div class="wrapper">
    ...
    <div class="main-content">
        <div class="header-bar">
            <button id="reassignBtn"><i class="fas fa-edit"></i> <?php echo $assignBtn;?></button>
            ...
            <main class="profile-content">
                ...
                <div class="user-info-section">
                    ...
                    <div class="user-details">
                        ...
                        <p class="user-type"><?php echo $tname; ?></p>
                    </div>
                </div>
                ...
                <div class="user-details-grid">
                    ...
                    <div class="grid-item">
                        ...
                        <div class="value-with-icon">
                            <span class="value"><?php echo $tname; ?></span>
                        </div>
                    </div>
                    <div class="grid-item">
