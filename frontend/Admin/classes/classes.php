...
<head>
    ...
    <script src="../js/add_class.js" defer></script>
...
<div class="wrapper">
    ...
    <div class="main-content">
        <div class="header-bar">
            <button id="newClass"><i class="fas fa-plus"></i> New Class</button>
            <button id="exportBtn"><i class="fas fa-download"></i> Download</button>
            <!--<button><i class="fas fa-file-arrow-up"></i> Bulk Create</button>-->
        ...
        <div class="profile-container">
            ...
            <main class="profile-content">
                ...
                <h2><?php echo totalContentsOf('aClasses'); ?> classes found</h2>
       ...
       <?php
          ...
          foreach ($classes as $class){
            ...
            <tr>
                ...
                <td><a href="/frontend/Admin/teachers/teacher/profile.php?id=<?php echo $class[2];?>"><?php echo getTeachersName($class[2]);?></a></td>
