...
<div id="export-classes" class="modal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <input id="fileName" value="<?php echo 'Classes' . '_' . date('Y-m-d')?>">
...
<div id="create-class" class="modal">
    <div class="modal-content">
        ...
        <span class="info">Choose programme, semester, subject, and teacher to create new class.</span>
        <div class="modal-body">
...
<select id="programme" class="createCLass">
      ...
      <select id="subject" name="sname" disabled class="createCLass">
          <option disabled selected>Select Subject</option>
               ...
               <select id="teacher" class="createCLass" name="tname">
        <option disabled selected>Select Teacher</option>
                <?php $teachers = getTeachers();
              foreach ($teachers as $teacher) { ?>
              <option value="<?php echo $teacher[0];?>"><?php echo $teacher[1] . ' ' . $teacher[2];?></option>
                <?php } ?>
           </select>
            </form>
      <div class="buttons">
