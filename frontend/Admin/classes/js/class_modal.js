...
createClassElements.forEach(classElement => {
    ...
    classElement.addEventListener('change', () =>{
        ...
        btn4.disabled = programme2.value === programmeOriginal || semester2.value === semesterOriginal || subject2.value === subjectOriginal || teacher2.value === teacherOriginal;
...
// 1. Show loading state
    ...
    const message = `Creating new class for  ${teacher2.options[teacher2.selectedIndex].text}`;
    toastr.info(message, title);
        ...
        if (response.ok) {
            ...
            if (data.success) {
                ...
                const toastData = {
                    ...
                    message: `New Class for ${teacher2.options[teacher2.selectedIndex].text} has been created successfully.`
                };
                ...
                toastr.error(`${data.error}!`, 'Creating New Class Failed');
            }
        } else {
