...
if (urlstring.includes('/teacher/class/class')){
...
if (urlstring.includes('/teacher/class/students')){
...
if (urlstring.includes('/teacher/class/attendance')){
    side3.style.backgroundColor = '#0078d4';
    side1.style.backgroundColor = '';
    side2.style.backgroundColor = '';
    side4.style.backgroundColor = '';
}
if (urlstring.includes('/teacher/class/attendance_report')){
